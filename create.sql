...
create table employee (employee_id bigint not null auto_increment, address varchar(255), birth_date date not null, email varchar(255), first_name varchar(255) not null, last_name varchar(255) not null, maden_name varchar(255), number_of_vacation_days_left integer not null, parent_name varchar(255) not null, phone_number varchar(255), sex varchar(255) not null, city_id bigint, company_id bigint, primary key (employee_id))
