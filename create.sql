...
create table employee (employee_id bigint not null auto_increment, address varchar(45) not null, birth_date date not null, email varchar(30), first_name varchar(15) not null, last_name varchar(15) not null, maden_name varchar(15), parent_name varchar(15) not null, phone_number varchar(20), sex varchar(1) not null, city_id bigint not null, company_id bigint, primary key (employee_id))
...
create table nonworking_day (non_working_day_id bigint not null auto_increment, date date not null, description varchar(255) not null, primary key (non_working_day_id))
create table professional_qualification (pqid bigint not null auto_increment, name varchar(30) not null, qualification_degree varchar(3) not null, primary key (pqid))
...
create table work_history (work_history_id bigint not null auto_increment, end_date date, previous_company varchar(255), start_date date not null, employee_id bigint, work_place_id bigint, primary key (work_history_id))
create table work_place (work_place_id bigint not null auto_increment, coefficient double precision not null, name varchar(255) not null, primary key (work_place_id))
