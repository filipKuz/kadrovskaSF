...
create table company (company_id bigint not null auto_increment, address VARCHAR(30), email VARCHAR(30), name VARCHAR(30) not null, phone_number VARCHAR(15), vat bigint not null, city_id bigint, primary key (company_id))
create table employee (employee_id bigint not null auto_increment, address varchar(255) not null, birth_date date not null, email varchar(255), first_name varchar(255) not null, last_name varchar(255) not null, maden_name varchar(255), parent_name varchar(255) not null, phone_number varchar(255), sex varchar(255) not null, city_id bigint, company_id bigint, primary key (employee_id))
...
create table work_place (work_place_id bigint not null auto_increment, additional_vacation_days integer, coefficient double precision not null, name VARCHAR(30) not null, primary key (work_place_id))
