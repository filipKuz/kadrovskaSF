...
create table professional_qualification (pqid bigint not null auto_increment, active tinyint(1) default 1 not null, name VARCHAR(30) not null, qualification_degree VARCHAR(30) not null, primary key (pqid))
