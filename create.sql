...
create table employee_professional_qualification (epqid bigint not null auto_increment, date_of_graduation date not null, educational_institution VARCHAR(30) not null, profession VARCHAR(30) not null, employee_id bigint, pqid bigint, primary key (epqid))
